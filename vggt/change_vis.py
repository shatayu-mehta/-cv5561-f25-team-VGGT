...
DEPTH_CUTOFF = 3.0           # Meters. Anything further is cut.
...
def process_single_dataset(dataset_path, model, device):
    ...
    save_ply(pts_full, cols_full, str(ply_folder / f"{dataset_name}_raw.ply"))
    ...
    for i in range(num_frames):
        ...
        cv2.imwrite(str(out_dir / "depths" / f"{i:06d}_depth.png"), d_color)
